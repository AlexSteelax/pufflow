...
public readonly struct Watermark : IEquatable<Watermark>, IComparable<Watermark>
{
    ...
    /// </summary>
    [PublicAPI] public const long NothingValue = -1;
    ...
    {
        return new Watermark(_value + long.CreateSaturating(interval.TotalMilliseconds));
    }
    ...
    [PublicAPI]
    public static Watermark FromEnvironmentTicks()
    {
        return new Watermark(Environment.TickCount64);
    }
    ...
    [PublicAPI]
    public static Watermark From(long value)
    {
    ...
    [PublicAPI]
    public static Watermark Nothing()
    {
        return new Watermark(NothingValue);
    }
    ...
    public static bool operator <(Watermark w1, Watermark w2)
    {
        return w1._value < w2._value;
    }
    ...
    {
        return obj is Watermark other && Equals(other);
    }
    ...
    public static implicit operator long(Watermark w)
    {
        return w._value;
    }
}