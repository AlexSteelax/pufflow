...
///             <item>
///                 <description>
///                     the chunk is full and rejects further elements (count trigger, driven by the
///                     <see cref="Chunker{T}" />);
///                 </description>
///             </item>
///             <item>
///                 <description><c>linger</c> elapsed since the first element of the current chunk (time trigger).</description>
///             </item>
///         </list>
///     </para>
///     <para>
