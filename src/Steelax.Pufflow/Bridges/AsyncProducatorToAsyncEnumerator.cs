...
//     ///     buffer is full, or the stream has already been completed via <see cref="TryComplete" /> and no
//     ///     more values can be written).
//     /// </returns>
...
//     /// </summary>
//     /// <remarks>
//     ///     The producer is the single writer: it signals completion itself through <see cref="TryComplete" />
...
//
//     /// <summary>
//     ///     Attempts to mark the stream as complete, waking any pending wait. A fault is propagated through
//     ///     the channel to <see cref="MoveNextAsync" />.
//     /// </summary>
...
//     {
//         return _queue.Writer.TryComplete(ex);
//     }
//
//     #endregion
//
...
//     ///     at the end of stream. A fault passed to <see cref="TryComplete" /> is propagated as an exception.
//     /// </returns>
