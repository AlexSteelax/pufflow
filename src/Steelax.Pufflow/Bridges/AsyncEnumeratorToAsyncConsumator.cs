...
/// <list type="bullet">
/// <item><description><b>Default</b> — owns a private fan-in; the bridge is fully self-contained.</description></item>
/// <item><description><b>Manual</b> — no fan-in and no signal; <see cref="TryPeek"/> and <see cref="Advance"/> are polled by the owner.</description></item>
/// <item><description><b>SharedAwaiter</b> — signals a caller-supplied fan-in and can wait on it via <see cref="WaitToReadAsync"/>.</description></item>
/// </list>
/// </para>
/// </remarks>
[PublicAPI]
